...
# Generated on: Wed Oct 09 23:13:38 UTC 2024 (Wed Oct 09 23:13:38 UTC 2024)
...
set_log_file fv/flpaddsub/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/flpaddsub -revised fv_map
...
elaborate_design -golden -root {flpaddsub} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/flpaddsub/fv_map.v.gz
elaborate_design -revised -root {flpaddsub}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/flpaddsub/rtl_to_fv_map.log
}
