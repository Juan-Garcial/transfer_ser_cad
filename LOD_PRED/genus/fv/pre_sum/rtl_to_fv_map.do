...
# Generated on: Wed Oct 09 20:12:36 UTC 2024 (Wed Oct 09 20:12:36 UTC 2024)
...
set_log_file fv/pre_sum/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/pre_sum -revised fv_map
...
elaborate_design -golden -root {pre_sum} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/pre_sum/fv_map.v.gz
elaborate_design -revised -root {pre_sum}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/pre_sum/rtl_to_fv_map.log
}
