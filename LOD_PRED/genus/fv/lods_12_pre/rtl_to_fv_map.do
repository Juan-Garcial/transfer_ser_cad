...
# Generated on: Tue Oct 15 00:28:15 UTC 2024 (Tue Oct 15 00:28:15 UTC 2024)
...
set_log_file fv/lods_12_pre/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lods_12_pre -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/edatools/cdnc/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/edatools/cdnc/GENUS211/tools.lnx86"
set env(CW_DIR) "/edatools/cdnc/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/edatools/cdnc/GENUS211/tools.lnx86/lib/chipware"

# default is to error out when module definitions are missing
set_undefined_cell black_box -noascend -both

add_search_path /home/joc/jc_work/LODs/genus/ -library -both
read_library -liberty -both /home/joc/jc_work/LODs/genus/sky130_fd_sc_hd__ff_100C_1v65.lib
...
add_search_path /home/joc/jc_work/LODs/rtl/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 -f  dv_list
elaborate_design -golden -root {lods_12_pre} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/lods_12_pre/fv_map.v.gz
elaborate_design -revised -root {lods_12_pre}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/lods_12_pre/rtl_to_fv_map.log
}
