...
# Generated on: Wed Oct 09 19:11:59 UTC 2024 (Wed Oct 09 19:11:59 UTC 2024)
...
set_log_file fv/lods_12/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lods_12 -revised fv_map
...
elaborate_design -golden -root {lods_12} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/lods_12/fv_map.v.gz
elaborate_design -revised -root {lods_12}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/lods_12/rtl_to_fv_map.log
}
