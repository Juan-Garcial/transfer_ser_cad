...
# Created by Genus(TM) Synthesis Solution 21.10-p002_1 on Tue Oct 15 00:30:03 UTC 2024

# This file contains the Genus script for /designs/lods_sw_12
...
::legacy::set_attribute -quiet runtime_by_stage {{PBS_Generic-Start 0 15 0.0 12.0} {to_generic 1 16 1 13} {first_condense 0 16 0 13} {PBS_Generic_Opt-Post 1 16 0.9852709999999991 12.985271} {{PBS_Generic-Postgen HBO Optimizations} 0 17 0.0 12.985271} {PBS_TechMap-Start 0 17 0.0 12.985271} {{PBS_TechMap-Premap HBO Optimizations} 0 17 0.0 12.985271} {second_condense 0 17 0 13} {reify 0 17 0 13} {global_incr_map 0 17 0 13} {{PBS_Techmap-Global Mapping} 0 17 0.9707830000000008 13.956054} {{PBS_TechMap-Datapath Postmap Operations} 1 18 1.0 14.956054} {{PBS_TechMap-Postmap HBO Optimizations} 0 18 -0.00016399999999983095 14.95589} {{PBS_TechMap-Postmap Clock Gating} 0 18 0.0 14.95589} {{PBS_TechMap-Postmap Cleanup} 0 18 -0.0001610000000002998 14.955729} {PBS_Techmap-Post_MBCI 0 18 0.0 14.955729}} /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid 0b790e7a-23b4-42a6-94f0-55a42a6f6f2e /
...
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/lods_sw_12
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 303} {cell_count 32} {utilization  0.00} {runtime 1 16 1 13} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 252} {cell_count 30} {utilization  0.00} {runtime 0 16 0 13} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 244} {cell_count 29} {utilization  0.00} {runtime 0 17 0 13} }{reify {wns 214748365} {tns 0} {vep 0} {area 101} {cell_count 19} {utilization  0.00} {runtime 0 17 0 13} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 101} {cell_count 19} {utilization  0.00} {runtime 0 17 0 13} }} /designs/lods_sw_12
::legacy::set_attribute -quiet is_sop_cluster true /designs/lods_sw_12
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/lods_sw_12
::legacy::set_attribute -quiet hdl_filelist {{default {-sv -f} {SYNTHESIS} {dv_list} {} {}}} /designs/lods_sw_12
::legacy::set_attribute -quiet hdl_user_name lods_sw_12 /designs/lods_sw_12
::legacy::set_attribute -quiet verification_directory fv/lods_sw_12 /designs/lods_sw_12
::legacy::set_attribute -quiet lp_clock_gating_max_flops inf /designs/lods_sw_12
::legacy::set_attribute -quiet arch_filename ../rtl/lovs_sw_12.sv /designs/lods_sw_12
::legacy::set_attribute -quiet entity_filename ../rtl/lovs_sw_12.sv /designs/lods_sw_12
::legacy::set_attribute -quiet original_name {a[11]} {/designs/lods_sw_12/ports_in/a[11]}
::legacy::set_attribute -quiet original_name {a[10]} {/designs/lods_sw_12/ports_in/a[10]}
::legacy::set_attribute -quiet original_name {a[9]} {/designs/lods_sw_12/ports_in/a[9]}
::legacy::set_attribute -quiet original_name {a[8]} {/designs/lods_sw_12/ports_in/a[8]}
::legacy::set_attribute -quiet original_name {a[7]} {/designs/lods_sw_12/ports_in/a[7]}
::legacy::set_attribute -quiet original_name {a[6]} {/designs/lods_sw_12/ports_in/a[6]}
::legacy::set_attribute -quiet original_name {a[5]} {/designs/lods_sw_12/ports_in/a[5]}
::legacy::set_attribute -quiet original_name {a[4]} {/designs/lods_sw_12/ports_in/a[4]}
::legacy::set_attribute -quiet original_name {a[3]} {/designs/lods_sw_12/ports_in/a[3]}
::legacy::set_attribute -quiet original_name {a[2]} {/designs/lods_sw_12/ports_in/a[2]}
::legacy::set_attribute -quiet original_name {a[1]} {/designs/lods_sw_12/ports_in/a[1]}
::legacy::set_attribute -quiet original_name {a[0]} {/designs/lods_sw_12/ports_in/a[0]}
::legacy::set_attribute -quiet original_name {c[3]} {/designs/lods_sw_12/ports_out/c[3]}
::legacy::set_attribute -quiet original_name {c[2]} {/designs/lods_sw_12/ports_out/c[2]}
::legacy::set_attribute -quiet original_name {c[1]} {/designs/lods_sw_12/ports_out/c[1]}
::legacy::set_attribute -quiet original_name {c[0]} {/designs/lods_sw_12/ports_out/c[0]}
::legacy::set_attribute -quiet original_name v /designs/lods_sw_12/ports_out/v
...
## Written on 00:30:04 15-Oct 2024
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid 0b790e7a-23b4-42a6-94f0-55a42a6f6f2e}
