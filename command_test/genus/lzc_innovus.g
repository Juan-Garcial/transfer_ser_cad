...
# Created by Genus(TM) Synthesis Solution 21.10-p002_1 on Thu Oct 03 21:09:22 UTC 2024

# This file contains the Genus script for /designs/lzc_8

######################################################################

::legacy::set_attribute -quiet init_lib_search_path /home/joc/jc_work/command_test/genus/ /
...
::legacy::set_attribute -quiet runtime_by_stage {{PBS_Generic-Start 0 14 0.0 12.0} {to_generic 1 16 0 12} {first_condense 0 16 0 13} {PBS_Generic_Opt-Post 1 16 0.9935969999999994 12.993597} {{PBS_Generic-Postgen HBO Optimizations} 0 16 0.0 12.993597} {PBS_TechMap-Start 0 16 0.0 12.993597} {{PBS_TechMap-Premap HBO Optimizations} 0 16 0.0 12.993597} {second_condense 0 16 0 13} {reify 0 16 0 13} {global_incr_map 0 16 0 13} {{PBS_Techmap-Global Mapping} 0 16 -0.017679999999998586 12.975917} {{PBS_TechMap-Datapath Postmap Operations} 1 17 1.0 13.975917} {{PBS_TechMap-Postmap HBO Optimizations} 0 17 0.0 13.975917} {{PBS_TechMap-Postmap Clock Gating} 0 17 0.0 13.975917} {{PBS_TechMap-Postmap Cleanup} 0 17 -0.00010700000000163357 13.97581} {PBS_Techmap-Post_MBCI 0 17 0.0 13.97581}} /
...
::legacy::set_attribute -quiet script_search_path /home/joc/jc_work/command_test/genus/ /
...
::legacy::set_attribute -quiet flow_metrics_snapshot_uuid e32818cd-07ac-46e0-89df-dd3b4a631b67 /
...
# END DFT SECTION
::legacy::set_attribute -quiet seq_reason_deleted_internal {} /designs/lzc_8
::legacy::set_attribute -quiet qos_by_stage {{to_generic {wns -11111111} {tns -111111111} {vep -111111111} {area 138} {cell_count 18} {utilization  0.00} {runtime 1 16 0 12} }{first_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 126} {cell_count 15} {utilization  0.00} {runtime 0 16 0 13} }{second_condense {wns -11111111} {tns -111111111} {vep -111111111} {area 126} {cell_count 15} {utilization  0.00} {runtime 0 16 0 13} }{reify {wns 214748365} {tns 0} {vep 0} {area 47} {cell_count 9} {utilization  0.00} {runtime 0 16 0 13} }{global_incr_map {wns 214748365} {tns 0} {vep 0} {area 47} {cell_count 9} {utilization  0.00} {runtime 0 16 0 13} }} /designs/lzc_8
::legacy::set_attribute -quiet seq_mbci_coverage 0.0 /designs/lzc_8
::legacy::set_attribute -quiet hdl_user_name lzc_8 /designs/lzc_8
::legacy::set_attribute -quiet hdl_filelist {{default {-sv -f} {SYNTHESIS} {dv_list} {} {}}} /designs/lzc_8
::legacy::set_attribute -quiet verification_directory fv/lzc_8 /designs/lzc_8
::legacy::set_attribute -quiet lp_clock_gating_max_flops inf /designs/lzc_8
::legacy::set_attribute -quiet arch_filename ../rtl/lz/lzc_8.sv /designs/lzc_8
::legacy::set_attribute -quiet entity_filename ../rtl/lz/lzc_8.sv /designs/lzc_8
::legacy::set_attribute -quiet original_name {a[7]} {/designs/lzc_8/ports_in/a[7]}
::legacy::set_attribute -quiet original_name {a[6]} {/designs/lzc_8/ports_in/a[6]}
::legacy::set_attribute -quiet original_name {a[5]} {/designs/lzc_8/ports_in/a[5]}
::legacy::set_attribute -quiet original_name {a[4]} {/designs/lzc_8/ports_in/a[4]}
::legacy::set_attribute -quiet original_name {a[3]} {/designs/lzc_8/ports_in/a[3]}
::legacy::set_attribute -quiet original_name {a[2]} {/designs/lzc_8/ports_in/a[2]}
::legacy::set_attribute -quiet original_name {a[1]} {/designs/lzc_8/ports_in/a[1]}
::legacy::set_attribute -quiet original_name {a[0]} {/designs/lzc_8/ports_in/a[0]}
::legacy::set_attribute -quiet original_name {c[2]} {/designs/lzc_8/ports_out/c[2]}
::legacy::set_attribute -quiet original_name {c[1]} {/designs/lzc_8/ports_out/c[1]}
::legacy::set_attribute -quiet original_name {c[0]} {/designs/lzc_8/ports_out/c[0]}
::legacy::set_attribute -quiet original_name v /designs/lzc_8/ports_out/v
...
## Written on 21:09:22 03-Oct 2024
#############################################################
#####   Flow Definitions   ##################################
...
if {[is_attribute flow_metrics_snapshot_uuid -obj_type root]} {set_flowkit_db flow_metrics_snapshot_uuid e32818cd-07ac-46e0-89df-dd3b4a631b67}
