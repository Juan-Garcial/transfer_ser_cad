...
# Generated on: Thu Oct 03 21:09:21 UTC 2024 (Thu Oct 03 21:09:21 UTC 2024)
...
set_log_file fv/lzc_8/rtl_to_fv_map.log -replace

usage -auto -elapse

set_verification_information rtl_fv_map_db

read_implementation_information fv/lzc_8 -revised fv_map
...
add_search_path /home/joc/jc_work/command_test/genus/ -library -both
read_library -liberty -both /home/joc/jc_work/command_test/genus/sky130_fd_sc_hd__ff_100C_1v65.lib
...
add_search_path /home/joc/jc_work/command_test/rtl/lz/ -design -golden
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab -sv09 -f  dv_list
elaborate_design -golden -root {lzc_8} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/lzc_8/fv_map.v.gz
elaborate_design -revised -root {lzc_8}
...
set lec_version_required "19.10100"
if {$lec_version >= $lec_version_required} {
analyze_results -logfiles fv/lzc_8/rtl_to_fv_map.log
}
